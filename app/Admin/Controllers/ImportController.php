...
class ImportController extends Controller
{
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            if ($action == 'report') {
                ...
                $content->header('Lịch sử nhập kho');
    ...
    {
        return Admin::grid(ImportWarehouse::class, function (Grid $grid) {
            ...
            // });
            $grid->quantity('Số lượng nhập');
           
            $grid->column('Tồn kho')->display(function () {
                return $this->product->quantity;
            });
            
            $grid->column('created_at', 'Ngày nhập')->display(function ($created_at) {
    ...
    protected function form($id = null)
    {
        ...
        $custom = Admin::form(ImportWarehouse::class, function (Form $form) use ($id) {
            $form->tab('Nhập kho sách', function ($form) {
                ...
                $form->text('quantity', 'Số lượng nhập')->rules('required', [
 ...
 */
    ...
    //         $content->body(Admin::show(ImportWarehouse::findOrFail($id)));
    //     });
    ...
    public function show($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            $content->header('');
            $content->description('');
            $content->body(Admin::show(ImportWarehouse::findOrFail($id), function (Show $show) {
                $show->id('ID');
            }));
        });
    }
