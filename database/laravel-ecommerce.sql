...
CREATE TABLE
    IF NOT EXISTS `admin_operation_log` (
        `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
VALUES (1, 2, NULL, NULL), (1, 15, NULL, NULL), (2, 15, NULL, NULL), (1, 19, NULL, NULL), (1, 20, NULL, NULL), (1, 12, NULL, NULL);
...
CREATE TABLE
    IF NOT EXISTS `admin_role_permissions` (
        `role_id` int(11) NOT NULL,
...
VALUES (1, 1, NULL, NULL), (3, 3, NULL, NULL), (3, 4, NULL, NULL), (2, 2, NULL, NULL), (2, 3, NULL, NULL), (2, 4, NULL, NULL), (4, 3, NULL, NULL), (4, 4, NULL, NULL), (2, 6, NULL, NULL), (2, 7, NULL, NULL), (2, 8, NULL, NULL), (2, 9, NULL, NULL);
...
CREATE TABLE
    IF NOT EXISTS `admin_role_users` (
        `role_id` int(11) NOT NULL,
        `user_id` int(11) NOT NULL,
        `created_at` timestamp NULL DEFAULT NULL,
        `updated_at` timestamp NULL DEFAULT NULL,
...
VALUES (1, 1, NULL, NULL), (3, 3, NULL, NULL);
...
VALUES (
        1,
        'admin',
        '$2y$10$KZD7OLW2TVusUIpyj/gXw.EHJY1XqM7oLsD5TsRGsZDn4bF7X8fpS',
        'Administrator',
        NULL,
        '6kMBW6SIFxIUdlnSrhCvERPmIV2F9FTW7voLbDpNVFV76v9KfbuF2By2F0qd',
        '2018-01-12 17:27:40',
        '2018-09-03 17:18:02'
    ), (
        3,
        'user',
        '$2y$10$5XHIa1PBq5y5XYqaE1Va.ulyxN8QFaFXyTqTcotp4uZj.kjsYTKKO',
        'User',
        NULL,
        NULL,
        '2018-01-12 18:05:28',
...
CREATE TABLE
    IF NOT EXISTS `admin_user_permissions` (
        `user_id` int(11) NOT NULL,
        `permission_id` int(11) NOT NULL,
        `created_at` timestamp NULL DEFAULT NULL,
        `updated_at` timestamp NULL DEFAULT NULL,
...
VALUES (
        7,
        'banner/938ac0ae30abf957f28209dbe03c7aa1.png',
        NULL,
        NULL,
        1,
        0,
        ...
        16,
        'banner/090309168aa9742bdcc04401252da078.png',
        NULL,
        ...
        17,
        'banner/0e34016e40b7ba61aa6ddb2d92af3c4b.png',
        NULL,
        NULL,
        1,
        0,
...
VALUES (
        1,
        'Thời trang',
        'cms_category/2ae26b97a9ae04d209acd33d2cf4b4fc.jpg',
        0,
        'chu-de-so-1',
        'chu-de-so-1',
        'chu-de-so-1',
        ...
        2,
        'Giải trí',
        'cms_category/a81accefc6a4f9417d8bd6742140a866.jpg',
        0,
        'Invoice,Template',
        'chu-de-so-2',
        'chu-de-so-2',
        ...
        3,
        'Ẩm thực',
        'cms_category/fd6fa3099b4e77989afd5cc99e637d67.jpg',
        0,
        'noi-dung-con',
        'noi-dung-con',
        'noi-dung-con',
...
VALUES (
        ...
        3,
        'Giải trí',
        'cms_content/6d92081ab17e3c11eb416005124a4a92.jpg',
        'Invoice,Template',
        'fdgdfg',
        '<p>fdgdfgdfgdfgdfgdfg fgfdg</p>\r\n\r\n<p>fghfgh</p>',
        0,
        1,
        '2018-02-10 03:22:10',
        '2018-09-01 21:25:51'
...
VALUES (
        1,
        3,
        'images/1f5eb6db2404b38b86e4246a792f3fac.png',
        0,
        0
    ), (
        2,
        3,
        'images/75be44c336696094632625d2d85159b1.jpg',
        0,
        0
    );
...
VALUES (
        ...
        4,
        'Tự làm mạch LED nháy theo nhạc VU 40 LED',
        ...
        'vu led,led nháy theo nhạc',
        NULL,
        'cms_content/dc3e4419930cfc5b1a15479dd7c6539b.png',
        0,
        1,
        '2018-08-02 17:59:52',
        '2018-09-06 06:25:06'
        ...
        'cms_content/ada03d03cceec88766ce3f95147a927a.png',
        0,
        1,
        '2018-08-09 13:44:08',
        '2018-09-06 06:24:55'
        ...
        'cms_content/8897eee9cbdb5c39a14a1048c5941197.png',
        0,
        1,
        '2018-08-09 13:50:36',
        '2018-09-06 06:24:44'
...
VALUES (
        1,
        'Trang chủ (sử dụng  nếu muốn đặt làm trang chủ)',
        '',
        NULL,
        NULL,
        NULL,
        ...
        'Giới thiệu',
        '',
        'Giới thiệu website,hướng dẫn đặt hàng',
        'Giới thiệu website',
        '<p><font color="#f39c12"><span style="font-size: 26px;"><b>Nội dung đang cập nhật</b></span></font></p>',
        'gioi-thieu',
        1
    ), (
        3,
        'Nội dung thông báo cho người dùng',
        NULL,
        'thông báo',
        NULL,
        '<h2>cập nhật</h2>',
        ...
        'liên hệ',
        NULL,
        '<p><strong>Vui l&ograve;ng li&ecirc;n hệ với ch&uacute;ng t&ocirc;i</strong></p>',
        'lien-he',
        1
    );
...
VALUES (
        ...
        '0',
        10,
        'Tự cấu hình SMTP gửi mail'
    ), (
        17,
        'config',
        'product_display_special',
        '1',
        17,
        ...
        '1',
        18,
        'Cho phép đặt hàng trước (mua trước thời gian bán chính thức)'
    ), (
        19,
        'config',
        ...
        20,
        'config',
        'product_buy_out_of_stock',
        '1',
        20,
        'Cho phép mua vượt stock, kể cả đã hết hàng'
    ), (
        21,
        'info',
        'site_fb_appID',
        ...
        '0',
        0,
        'Sử dụng paypal cho thanh toán'
    ), (
        26,
        'info',
        'site_phone_long',
        'Sale: 0168.123.1209 - Kỹ thuật: 0123.448.559',
        6,
        'Sô điện thoại dài'
    );
...
VALUES (
        ...
        4,
        '2018_03_27_145238_create_jobs_table',
        2
    ), (
        5,
        '2018_03_27_145322_create_failed_jobs_table',
        2
    ), (
        6,
        '2016_05_17_221000_create_promocodes_table',
        3
    );
...
VALUES (
        'test@gmail.com',
        '$2y$10$Hig4bWDSh3NzYchxkAK5sOqNYs3dx2oYJMLZ5z6k.1bP91/kTYFyu',
        '2018-01-14 14:23:29'
    ), (
        'lanhktc@gmail.com',
        '$2y$10$G/hr0KbnfvPzK4xRQ/9SiOzwVTxUACo3tPvd8vsgNsd2QKSkRJrCW',
        '2018-08-14 22:50:13'
    );
...
VALUES (
        ...
        100000,
        1,
        'Tặng điểm khách hàng thân thiết',
        22,
        1,
        1,
        NULL
...
VALUES (
        1,
        'Husq',
        'brand/88360597aa1df738b183d2a2a5e41d92.png',
        NULL,
        1,
        0
    ), (
        2,
        'Ideal',
        'brand/d0782fc5b01353d0b47c5d6b434e282e.png',
        NULL,
        1,
        0
    ), (
        3,
        'Apex',
        'brand/4cbebcdaa679d1dcafccb620d3aea0c9.png',
        NULL,
        1,
        0
    ), (
        4,
        'CST',
        'brand/69763cbe8e62f0de5d54e7a175167b21.png',
        NULL,
        1,
        0
    ), (
        5,
        'Klein',
        'brand/3ef3fc68fb5257294c4a796b0ae08e08.png',
        NULL,
        1,
        0
    ), (
        6,
        'Metabo',
        'brand/66afc30e21e9ada47493dccfad00bd34.png',
        NULL,
        1,
        0
    );
...
VALUES (
        1,
        'Sản Phẩm Khác',
        'category/4931e5a7d7d9d7d05f04d7a02e5f5220.jpg',
        'sản phẩm',
        'san-pham-khac',
        NULL,
        0,
        ...
        2,
        'IoT - Nhà Thông Minh',
        'category/c6590e1c7eb85bb04e8139841c6be2a2.jpg',
        'iot',
        'iot',
        NULL,
        0,
        ...
        3,
        'Arduino & Module',
        'category/54e2ef1ef79c001fc01e807660ae8bd2.jpg',
        'arduino',
        'arduino',
        NULL,
        0,
        ...
        4,
        'Linh Kiện Điện Tử',
        'category/d940bc2bea094a9c5827ab0374305d14.png',
        'linh kiện điện tử',
        'linh-kien-dien-tu',
        NULL,
        0,
        ...
        5,
        'In 3D & Phụ Kiện',
        'category/cad79714a9ae688f20a5e3a4d4c5cd50.jpg',
        'in 3d',
        'in-3d',
        NULL,
        0,
        ...
        6,
        'Quạt Đèn LED - LED FAN',
        'category/aa540f347868c296cfd76f8ab79f8bcd.jpg',
        'quạt đèn led, led fan',
        'led fan',
        NULL,
        9,
        ...
        7,
        'ICs',
        'category/6b456e8c650aee6c7aa4b8ccc40f63b2.png',
        'ic',
        'ic',
        NULL,
        4,
        ...
        8,
        'Màn Hình LCD',
        'category/a7b975571ee43d76aa5fa35566489c7c.jpg',
        'lcd',
        'lcd',
        NULL,
        4,
        ...
        9,
        'Quà Tặng Công Nghệ',
        'category/1cd464f619ad5ea7d8d03a8b3109718a.jpg',
        'quảng cáo, holo 3d, led fan',
        'san-pham-cong-nghe',
        ...
        10,
        'Máy In 3D',
        'category/2203e3214ab89829309d5ea92fd8f3b7.jpg',
        'máy in 3d',
        'may-in-3d',
        NULL,
        5,
        ...
        11,
        'Linh Kiện & Phụ Kiện Máy In 3D',
        'category/1adac36e4eaf99495236d79a8cd3c042.png',
        'diy, ráp máy in 3d',
        'linh-kien-may-in-3d',
        NULL,
        5,
        ...
        'category/8498d6dcd0edfb104fb40a993eb0f0d4.jpg',
        'quatang,ledfan,quạt,hologram, quảng cáo',
        '3d-hologram-led-fan',
        NULL,
        9,
        3,
        ...
        13,
        'Quạt Đồng Hồ LED - CLOCK FAN',
        'category/59d50efb0f679283ce6e5c2a73b45496.jpg',
        'quatang,ledfan',
        'clock-fan',
        NULL,
        9,
        ...
        14,
        'Cảm Biến',
        'category/1820e20708133bc8ca10c9d965f1c598.jpg',
        'cảm biến, sensor',
        'sensor',
        NULL,
        4,
        ...
        15,
        'Nhựa In 3D',
        'category/2e474e37a988d6eada7bc719fbf6d0cd.jpg',
        'in 3d, dịch vụ in 3d, 3d print, filament, tạo mẫu nhanh',
        'filament',
        NULL,
        5,
        ...
        19,
        'Đèn LED - Ánh Sáng',
        'category/e6902fd337f04ed8bc8fa9ded815261a.jpg',
        'led,led dây,led strip',
        'led-strip',
        NULL,
        4,
        0,
...
VALUES (
        82,
        'product_slide/978d5992ff828e7a0391dbbc7cf02383.png',
        38,
        0,
        0
    ), (
        83,
        'product_slide/f4786d81509a8d8ffa461535b07c77bc.png',
        38,
        0,
        0
    ), (
        84,
        'product_slide/8d94e8b45b33e3f13dd5be5376ffd9f8.png',
        39,
        0,
        0
    ), (
        87,
        'product_slide/a2f94aa1837cdcad9e101618b3a8b131.png',
        40,
        0,
        0
    ), (
        88,
        'product_slide/81f37c10d867710075e3ab6153a31d03.png',
        40,
        0,
        0
    ), (
        89,
        'product_slide/1e758549544c3d02e618c44770944a1c.png',
        42,
        0,
        0
    ), (
        90,
        'product_slide/8718dfdb75f951010cdce669768c3e3a.png',
        42,
        0,
        0
    ), (
        92,
        'product_slide/555968c4c92f4ebed6b3cfbffa4d7b46.jpg',
        43,
        0,
        0
    ), (
        93,
        'product_slide/dbe75df3ad00c5e282e27e949542caf8.jpg',
        43,
        0,
        0
    ), (
        94,
        'product_slide/d8033da37b4864808ddc66f509d33591.jpg',
        43,
        0,
        0
    ), (
        95,
        'product_slide/bf698711a126af552a9b7ec26e5717d2.png',
        44,
        0,
        0
    ), (
        96,
        'product_slide/9621378ea3e33142ee2158fcd86c76a4.png',
        45,
        0,
        0
    ), (
        102,
        'product_slide/9d28a11ae7e4e6b16beffa765469d540.png',
        48,
        0,
        0
    ), (
        103,
        'product_slide/e1d55480c5aca361f54a4fc392073c52.png',
        48,
        0,
        0
    ), (
        109,
        'product_slide/bf4f360ac5c458c32f4597f0ff00493d.png',
        49,
        0,
        0
    ), (
        110,
        'product_slide/bcf85f60d3fe35de2c1be6272f9605ef.png',
        52,
        0,
        0
    ), (
        111,
        'product_slide/40999526f41b1d4090e30c6b0ce21dca.jpg',
        53,
        0,
        0
    ), (
        112,
        'product_slide/cdc0fcaeef1a846c9993a272c1518922.jpg',
        54,
        0,
        0
    );
...
VALUES (1, 'Màu sắc', 1, 1, 0), (2, 'Kích thước', 2, 1, 0), (3, 'Chất liệu', 3, 1, 3);
...
CREATE TABLE
    IF NOT EXISTS `shop_option_detail` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
...
VALUES (1, 'X', 0, 2, 0), (2, 'XL', 10000, 2, 0), (3, 'Đỏ', 0, 1, 0), (4, 'Xanh', 10000, 1, 0), (5, 'Vàng', 5000, 1, 0), (24, 'Tím', 20000, 1, 15), (47, 'Tìm', 0, 2, 16), (48, 'Ok', 0, 2, 16), (49, 'Xanh', 0, 1, 17), (50, 'Do', 0, 1, 17), (569, 'White/Đen', 0, 1, 9), (570, 'Black/Đen', 0, 1, 9), (
        571,
        'Transparent/Trong suốt',
        0,
        1,
        9
    ), (572, 'Red/Đỏ', 0, 1, 9), (573, 'Yellow/Vàng', 0, 1, 9), (574, 'Blue/Xanh Dương', 0, 1, 9), (575, 'Green/Xanh Lá', 0, 1, 9), (576, 'Orange/Cam', 0, 1, 9), (577, 'Cyan/Lam', 0, 1, 9), (578, 'Pink/Hồng', 0, 1, 9), (
        579,
        'Đường kính 1.75mm',
        0,
        2,
        9
    ), (580, 'Đường kính 3mm', 0, 2, 9), (581, 'S', 0, 2, 6), (582, 'XL', 0, 2, 6), (583, 'S', 0, 2, 5), (584, 'XL', 0, 2, 5), (585, 'XXX', 0, 2, 5), (606, 'Màu xanh', 0, 1, 12), (607, 'Màu đỏ', 0, 1, 12), (608, 'Màu tím', 0, 1, 12), (609, 'XL', 0, 2, 12), (610, 'XXL', 0, 2, 12), (621, 'Màu Trắng Đục', 0, 1, 34), (622, 'Trong Suốt', 0, 1, 34), (
        623,
        'ID=2 mm, OD=4 mm',
        0,
        2,
...
VALUES (
        ...
        74,
        32,
        'Dây Gia Nhiệt 12V 40W Máy In 3D',
        20000,
        1,
        20000,
        '3D-HOTWIRE1240',
        ...
        75,
        44,
        'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc',
        15000,
        1,
        15000,
        'P10-IRG',
...
CREATE TABLE
    IF NOT EXISTS `shop_order_history` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
...
VALUES (
        ...
        41,
        74,
        'Thay đổi <b>comment</b> từ <span style="color:blue">\'\'</span> thành <span style="color:red">\'ok\'</span>',
        1,
        0,
        '2018-09-03 17:14:49'
    ), (
        42,
        74,
        'Thay đổi <b>shipping</b> từ <span style="color:blue">\'\'</span> thành <span style="color:red">\'10000\'</span>',
        1,
        0,
        '2018-09-03 17:14:55'
    ), (
        43,
        39,
        'Thay đổi <b>status</b> từ <span style="color:blue">\'4\'</span> thành <span style="color:red">\'1\'</span>',
        1,
        0,
        '2018-09-03 17:17:00'
    ), (
        44,
        39,
        'Thay đổi <b>received</b> từ <span style="color:blue">\'\'</span> thành <span style="color:red">\'-1060000\'</span>',
        1,
        0,
        '2018-09-03 17:17:09'
    ), (
...
CREATE TABLE
    IF NOT EXISTS `shop_order_status` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
        `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
        PRIMARY KEY (`id`)
    ) ENGINE = InnoDB AUTO_INCREMENT = 5 DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci;
...
INSERT INTO
    `shop_order_status` (`id`, `name`)
VALUES (0, 'Mới'), (1, 'Đang xử lý'), (2, 'Tạm giữ'), (3, 'Hủy bỏ'), (4, 'Hoàn thành');
...
CREATE TABLE
    IF NOT EXISTS `shop_order_total` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
    IF NOT EXISTS `shop_payment_status` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
        `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
        PRIMARY KEY (`id`)
    ) ENGINE = InnoDB AUTO_INCREMENT = 4 DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci;
...
INSERT INTO
    `shop_payment_status` (`id`, `name`)
VALUES (0, 'Chưa thanh toán'), (1, 'Thanh toán một phần'), (2, 'Thanh toán xong'), (3, 'Khách hàng dư tiền');
...
VALUES (
        ...
        'quatang,ledfan',
        '',
        'product/2ba0e7a82ca5ad2acc2514c90e3e7854.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        3,
        6,
        NULL,
        ...
        'quatang,ledfan',
        '',
        'product/4df7dbf5ab7a25605ed072d7a34199af.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        2,
        13,
        NULL,
        ...
        'quatang,ledfan',
        '',
        'product/743a375879e90599f75b4e98bacf0b95.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        1,
        13,
        NULL,
        ...
        'quatang,ledfan',
        '',
        'product/d4f0b048fb171a8bf4f9701fcbac949d.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        8,
        15,
        NULL,
        ...
        'quatang,ledfan',
        '',
        'product/d486cdb9fad4205d4b7367f2c9df1f9e.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        1,
        11,
        NULL,
        ...
        'quatang,ledfan',
        '',
        'product/92ddb03b751db23fbac398d887f3164f.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        7,
        10,
        NULL,
        ...
        'quatang,ledfan',
        '',
        'product/3504e19458e349a6316c568f158de4f0.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        11,
        NULL,
        ...
        'quatang,ledfan',
        NULL,
        'product/1ed5aca62cbd385f3f90b85a366a55f8.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        11,
        '',
        ...
        'quatang,ledfan',
        NULL,
        'product/4c076364baac8604c4a32ac3eaaaf6b0.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        16,
        '',
        ...
        'quatang,ledfan',
        NULL,
        'product/d2bc18712eaea24237bfdfaac070c74a.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        17,
        '',
        ...
        'quatang,ledfan',
        NULL,
        'product/3d9543ddacfe442ee27111ebc94cee73.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        19,
        '',
        ...
        'quatang,ledfan',
        NULL,
        'product/f3dd749e2d58243e2d336b149c4a1235.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        19,
        '',
        ...
        'quatang,ledfan',
        NULL,
        'product/979417f469dd1ec60a09d2d4fd7729c3.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        0,
        19,
        '',
        ...
        'quatang,ledfan',
        NULL,
        'product/fcb202f533939bca1f4132d89e734b28.png',
        '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>',
        2,
        2,
        '2',
...
CREATE TABLE
    IF NOT EXISTS `shop_product_like` (
...
CREATE TABLE
    IF NOT EXISTS `shop_product_recent_view` (
        `user_id` int(11) NOT NULL,
        `product_id` int(11) NOT NULL,
...
INSERT INTO
    `shop_product_recent_view` (
        `user_id`,
        `product_id`,
        `created_at`
    )
VALUES (3, 35, '2018-08-27 15:58:21'), (3, 38, '2018-08-27 16:44:08'), (3, 41, '2018-08-27 17:19:33'), (3, 42, '2018-08-27 17:02:03'), (3, 44, '2018-08-27 17:19:52'), (3, 46, '2018-08-27 17:14:29'), (3, 47, '2018-08-27 17:01:57'), (3, 48, '2018-08-27 17:01:49');
...
CREATE TABLE
    IF NOT EXISTS `shop_product_type` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
...
VALUES (
        ...
        'BX-5UT-s',
        454,
        'product/4c28c6a2fc6a3fa79197798707d55b5c.png',
        48
    ), (
        4,
        '34324234',
        'BX-5UT-T',
        1111,
        'product/293da323794f89ee2d7962f44f930393.png',
        48
    ), (
        12,
        'fdgdfg',
        'fgdfgd',
        NULL,
        'product/68f8a4d063e4ddef447616116dd03e0f.png',
        42
    ), (
        13,
        'bnmbnmbn',
        'BX-5U0-1fgfgjghjhgj',
        NULL,
        'product/2702691387f97f5985843cbb243d267c.png',
        42
    ), (
        16,
        'Sản phẩm xanh',
        'BX-5U0-1fgfgkjh',
        NULL,
        'product/777274d55ff7adeef36ca930022a8db9.jpg',
        29
    ), (
        17,
        'Sản phẩm xanh',
        'BX-5U0-1fgfgl',
        NULL,
        'product/0ba3c6a927bb0e2cd2d54ce0c13df919.jpg',
        30
    ), (
        18,
        'Sản phẩm xanh',
        'BX-5U0-1fgfgg',
        NULL,
        'product/7eb3eefcb94b7548cc4942a42f36e186.jpg',
        27
    ), (
        19,
        'Sản phẩm xanh',
        'BX-5U0-1fgfgbnvbn',
        NULL,
        'product/7e9ee7a382be733ad68172e6abd11a95.png',
        49
    );
...
CREATE TABLE
    IF NOT EXISTS `shop_shipping_address` (
        `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
        `user_id` int(11) NOT NULL,
        `address1` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
        `address2` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE
    IF NOT EXISTS `shop_shipping_status` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO
    `shop_shipping_status` (`id`, `name`)
VALUES (0, 'Chưa gửi'), (1, 'Đang gửi'), (2, 'Gửi xong');
...
CREATE TABLE
    IF NOT EXISTS `shop_shoppingcart` (
...
CREATE TABLE
    IF NOT EXISTS `shop_special_price` (
        `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
        `product_id` int(11) NOT NULL,
        `price` int(11) NOT NULL,
...
VALUES (
        ...
        '$2y$10$yMT7ox6mh6kRQon.06MXZue.PBTwhT0xFLM9s7RDVgLYrMM/sBJHu',
        '122/23B, Tôn Thất Tùng',
        'Quận 7',
        '009404945435',
        'V5VfBF0g3ZjllZJyFo9Guh2E5dxIAA5HlpJScrAplZxmSMjJKiQO6W4m90kh',
        '2018-01-14 03:12:50',
        '2018-09-03 17:13:27'
    ), (
        2,
        'Hung',
        'hung@fdgfdg.com',
        '$2y$10$eGf2jiO3I7wj879B0RRBBuZgvVvDJLQKP0HF88ZCgr4ti50AgznuO',
        'Quan 1',
        'Ho chi Minh',
        '099789987686',
        NULL,
        ...
        'Lê Văn Lanh',
        'asakc@gmail.com',
        '$2y$10$4HMDRFpiNXRPYitWP7tDhuYsCYKGK3QFiRvyeQxYbsyzgmsabRrhS',
        'Quan 12',
        'Ho chi minh',
        '0667151172',
        'g9VXHoi7COeHAzffYZvms8I8hVZc0pjbMgp92mbGy8LPpOIlacvOnV6u2LvG',
        '2018-02-04 09:56:12',
        '2018-09-03 17:13:17'
    ), (
        4,
        ...
        '$2y$10$udnwsVhfef3QcS8oP8OEsuHg9eKTTI7lb0q6Zffd9jHiEGnIIxUBe',
        'Tân Kỳ',
        'Hồ Chí Minh',
        '0664456189',
        'iYg2W7K79pAleTv2Q0rHsRCsMkx8lLN4l2fTE8o8GlLKBHyrj3TeHvIjWYgt',
        '2018-03-12 16:20:04',
        '2018-05-09 15:00:55'
    ), (
        5,
        ...
        '$2y$10$/DzsZSjPNLRY8NlrMk5lselrbMYQdmr90tXBPlYQe8CNsi1JQFyse',
        '12',
        'TTh07',
        '09012345678',
        NULL,
